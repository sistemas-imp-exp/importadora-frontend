...
const VACIO: Cliente = { id: 0, nombre: "", activo: true };

function ClienteForm({ onGuardar, onCancelar, cliente }: ClienteFormProps) {
    ...
    useEffect(() => {
        setForm(cliente ? { ...cliente } : VACIO);
        if (!cliente && nombreInputRef.current) {
        ...
        <form onSubmit={guardar}>
            ...
            <div className="d-flex flex-wrap justify-content-between align-items-center gap-3 pt-3 mt-4 border-top">
                <div className="form-check">
                    ...
                    />
                    <label className="form-check-label" htmlFor="cliente-activo">Activo</label>
                </div>
                ...
                <div className="d-flex gap-2">
                    ...
                    {isLoading ? (
                        ...
                        <button type="submit" className="btn btn-primary">
                            ...
                            {form.id === 0 ? "Registrar cliente" : "Guardar cambios"}
                        </button>
                    )}
                </div>
            </div>
